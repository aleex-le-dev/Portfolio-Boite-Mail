...
const RepondreMail = ({
  ...
  return (
    <div className={`rounded-2xl shadow-xl w-[420px] max-w-full p-0 border ${darkMode ? 'bg-gray-800 border-gray-600' : 'bg-white border-gray-200'}`} style={darkMode ? { backgroundColor: 'var(--dark-primary-bg)' } : {}}>
      ...
      <form className="flex flex-col gap-3 px-5 py-4" onSubmit={handleSubmit}>
        <input
          ...
          style={darkMode ? { backgroundColor: 'var(--dark-secondary-bg)', borderColor: 'var(--dark-border)' } : {}}
          placeholder="Subject"
          value={subject}
          readOnly
        />
